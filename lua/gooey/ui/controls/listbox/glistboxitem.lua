...
function PANEL:SetListBoxItem (listBoxItem)
	...
	if self.ListBoxItem then
		...
		GLib.UnbindProperty (self,           self.ListBoxItem, "ToolTipText",     "Gooey.ListBoxItem." .. self:GetHashCode ())
	...
	if self.ListBoxItem then
		...
		GLib.BindProperty (self,           self.ListBoxItem, "ToolTipText",     "Gooey.ListBoxItem." .. self:GetHashCode ())
