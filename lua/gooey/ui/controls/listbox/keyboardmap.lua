Gooey.ListBox.KeyboardMap = Gooey.KeyboardMap ()

Gooey.ListBox.KeyboardMap:Register (KEY_PAGEUP,
...
Gooey.ListBox.KeyboardMap:Register (KEY_PAGEDOWN,
	function (self, key, ctrl, shift, alt)
		self.VScroll:ScrollAnimated (self.ScrollableViewController:GetViewHeight ())
		return true
	end
...
Gooey.ListBox.KeyboardMap:Register (KEY_HOME,
	function (self, key, ctrl, shift, alt)
...
Gooey.ListBox.KeyboardMap:Register (KEY_END,
	function (self, key, ctrl, shift, alt)
...
Gooey.ListBox.KeyboardMap:Register (KEY_A,
	function (self, key, ctrl, shift, alt)
