...
function PANEL:HookControl (control)
	...
	control:AddEventListener ("HeightChanged", "Gooey.VerticalLayout." .. self:GetHashCode (),
		function (_, _)
			self:InvalidateVerticalItemLayout ()
		end
	)
...
function PANEL:UnhookControl (control)
	...
	control:RemoveEventListener ("HeightChanged", "Gooey.VerticalLayout." .. self:GetHashCode ())
end
...
Gooey.Register ("GVerticalLayout", PANEL, "GPanel")